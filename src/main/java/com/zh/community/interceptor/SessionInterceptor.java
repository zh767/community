package com.zh.community.interceptor;

import com.zh.community.enums.AdPosEnum;
import com.zh.community.mapper.UserMapper;
import com.zh.community.model.User;
import com.zh.community.model.UserExample;
import com.zh.community.service.AdService;
import com.zh.community.service.impl.NotificationServiceImpl;
...
public class SessionInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        //获取到cookie的token 判断数据库有没有 放到session中
